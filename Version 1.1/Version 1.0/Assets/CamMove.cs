...
public class CamMove : MonoBehaviour {
	...
	void Update () {
		if (target) {
			...
			Vector3 delta = target.position - cameraFollow.ViewportToWorldPoint (new Vector3 (0.5f, point.y, point.z));	//take away the transform needed from viewport to world
