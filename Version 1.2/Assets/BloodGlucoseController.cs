...
public class BloodGlucoseController : MonoBehaviour 
{
	...
	void Update () 
    {
        ...
        {
            increaseGlucoseLevel();
        }
        if (Input.GetKeyDown(KeyCode.LeftArrow))
        {
            decreaseGlucoseLevel();
        }
